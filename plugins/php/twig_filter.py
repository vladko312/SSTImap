...
class Twig_filter(php.Php):
    ...
    priority = 7
    plugin_info = {
        "Description": """Mostly mirrors 'Twig' plugin, but supports versions >=2.10 and >=3.0""",
        "Authors": [
            "Vladislav Korchagin @vladko312 https://github.com/vladko312",  # Automatic payload for Twig >=2.10
